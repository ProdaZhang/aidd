# AIDD common-mistakes quick reference (pitfalls actually hit)

> **Purpose**: skim before working in the **system** / **handoff** phases. The pitfalls here are **all ones exposed during actual development/validation with AIDD** (project details neutralized), not textbook examples — each gives symptom / root cause / correct practice.
