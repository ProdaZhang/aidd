...
> Strongly-typed fields. Filled in during the **concept** phase when starting the project; if discussion goes deeper you can come back and revise, and log it in CHANGELOG (the change ledger) when you do.
...
## One-line Concept
`<What this system / product is, in one sentence>`
...
- **Enum dimensions**: `<which independent classification dimensions this project has, and the domain of each, e.g. plan tier 1-N / account status / resource type (or for a game: item rarity / equipment quality), one set each>`
