...
> **AIDD project-environment prerequisite** (the only one): the spine's re-entrancy relies on this — every time you change a file, append a line at the end; switching AIs / across sessions you can trace back "what was done, and why".
...
> The backfill rule is enforced by methodology step 5 + quality-gate item 8, and **does not depend on any host-AI instruction file** (CLAUDE.md / AGENTS.md / GEMINI.md etc. are the runtime environment's business, not AIDD's).
