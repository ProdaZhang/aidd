...
- System statuses are in the manifest (Draft / Prototyping / Final / Recheck); **only implement finalized systems**, draft systems may still change, and `Recheck` systems need confirmation first.
